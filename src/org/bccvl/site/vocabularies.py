...
traits_functions_species_source = CatalogVocabularyFactory(
    ...
    query={
        ...
        'object_provides': 'org.bccvl.site.content.function.IFunction',
        # FIXME: find another way to separate SDM and traits "functions"
        'id': ['speciestrait_cta', 'speciestrait_glm', 'speciestrait_gam', 'speciestrait_glmm'],
        'sort_on': 'sortable_title',
    },
)
...
genre_vocabulary = SimpleVocabulary([
    ...
    SimpleTerm("DataGenreSpeciesOccurEnv",
               "DataGenreSpeciesOccurEnv", "Species Occurrence with Environmental"),
    SimpleTerm("DataGenreSpeciesAbsenceEnv",
               "DataGenreSpeciesAbsenceEnv", "Species Absence with Environmental"),    
    SimpleTerm("DataGenreSpeciesCollection",
               "DataGenreSpeciesCollection", "Species Occurrence Collection"),
    SimpleTerm("DataGenreSpeciesAbsenceCollection",
               "DataGenreSpeciesAbsenceCollection", "Species Absence Collection"),
    ...
    SimpleTerm("DataGenreFP_ENVLOP", "DataGenreFP_ENVLOP", "Future Projection over Environmental envelope"),
    SimpleTerm("DataGenreFP_GRAPH", "DataGenreFP_GRAPH", "Future Projection graph"),
    ...
    SimpleTerm("DataGenreClimateChangeMetricMap",
               "DataGenreClimateChangeMetricMap", "Climate Change Metric map"),
